...
test('sdkActions.createBatchStorage', () => {
  ...
  const expected = [['foo', 'bar'], ['baz', 'bee']];
...
test('sdkActions.appSetStorage', () => {
  ...
  return store.dispatch(sdkActions.appSetStorage(key)).then(() => {
...
test('sdkActions.appGetStorage', () => {
  ...
  return store.dispatch(sdkActions.appGetStorage(key, value)).then(() => {
    expect(store.getActions()).toEqual(expectedActions);
...
test('sdkActions.entitySetStorage', () => {
  ...
  return store.dispatch(sdkActions.entitySetStorage(key)).then(() => {
    expect(store.getActions()).toEqual(expectedActions);
...
test('sdkActions.entityGetStorage', () => {
  ...
  return store.dispatch(sdkActions.entityGetStorage(key, value)).then(() => {
    expect(store.getActions()).toEqual(expectedActions);
...
test('sdkActions.oauthGetSettings', () => {
  ...
  return store.dispatch(sdkActions.oauthGetSettings(provider)).then(() => {
    expect(store.getActions()).toEqual(expectedActions);
